-- ==============================================================================
-- KỊCH BẢN LẤY MINH CHỨNG THỰC TẾ CHO BÁO CÁO ĐỒ ÁN WMS
-- Hướng dẫn: 
-- 1. Copy toàn bộ file này dán vào MySQL Workbench
-- 2. Bấm Ctrl + A (chọn hết) -> Bấm hình tia sét (Run)
-- 3. Chụp ảnh màn hình các bảng kết quả để dán vào tài liệu
-- ==============================================================================
