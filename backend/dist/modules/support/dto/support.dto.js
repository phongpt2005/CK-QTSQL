...
exports.UpdateStatusDto = exports.CreateTicketDto = void 0;
...
__decorate([
    (0, class_validator_1.IsString)({ message: 'Chủ đề phải là chuỗi ký tự' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Chủ đề không được để trống' }),
...
__decorate([
    (0, class_validator_1.IsString)({ message: 'Trạng thái phải là chuỗi ký tự' }),
