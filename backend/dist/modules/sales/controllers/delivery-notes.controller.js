...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create delivery note (delivers goods → decreases inventory)' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, current_user_decorator_1.CurrentUser)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.CreateDeliveryNoteDto, Number]),
    __metadata("design:returntype", void 0)
], DeliveryNotesController.prototype, "create", null);
exports.DeliveryNotesController = DeliveryNotesController = __decorate([
    (0, swagger_1.ApiTags)('Delivery Notes'),
